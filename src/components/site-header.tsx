      ...
      <div className="mx-auto flex h-[76px] w-full items-center justify-between px-5 sm:px-8 lg:px-11">
        <div className="flex min-w-0 items-center gap-6 sm:gap-7">
          ...
          <Link href="/" aria-label="Paperbag home" className="shrink-0">
            <img src="/paperbag-wordmark.svg" alt="Paperbag" className="h-6 w-auto" />
          </Link>
        </div>
          ...
          {!user ? (
            <>
              <SignInButton mode="modal">
                <button className="rounded-full border-2 border-black px-4 py-1.5 text-[14px] font-semibold leading-[0.8] tracking-[-0.052em] transition-colors hover:bg-black hover:text-white sm:px-5">
                  Log in
                </button>
              </SignInButton>
              <Link href="/restaurant/new" className="hidden items-center gap-2 rounded-full bg-black px-5 py-2 text-[14px] font-semibold leading-[0.8] tracking-[-0.052em] text-white transition-opacity hover:opacity-80 sm:inline-flex">
